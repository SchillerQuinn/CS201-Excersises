/*****************
 * An ADT that represents a mathematical set.
 * Items are kept in sorted order, and duplicates are not allowed.
 * @author Andy
 *
 */
public interface SortedSetADT<T extends Comparable<T>> {
